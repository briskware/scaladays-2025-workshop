...
case class HttpError(statusCode: StatusCode, message: String) extends RuntimeException(message) {
  def this(statusCode: StatusCode, message: String, cause: Throwable) = {
